...
differ.
% UPGRADE (after sharp-constant milestone): replace the two sentences
% above with: "The Lean formalization now also establishes the explicit
% bound e(G) <= 2(a-1)(b-1) (module SharpConstant.lean), matching the
% argument above."
